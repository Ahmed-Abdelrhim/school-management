                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.slider') }}" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="id" @if(isset($homeslide))  value="{{ $homeslide->id }}" @endif>

                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Title</label>
                                    <div class="col-sm-10">
                                        <input name="title" class="form-control" type="text"
                                               @if(isset($homeslide)) value="{{ $homeslide->title }}" @endif id="example-text-input">
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="short_title" class="form-control" type="text"
                                               @if(isset($homeslide)) value="{{ $homeslide->short_title }}" @endif  id="example-text-input">
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="video_url" class="form-control" type="text"
                                               @if(isset($homeslide)) value="{{ $homeslide->video_url }}" @endif id="example-text-input">
                                    </div>
                                </div>
                                <!-- end row -->
